...
FAST Certification Test #01: Static Elliptic wing
---------------------- SIMULATION CONTROL --------------------------------------
...
"EllipticWing/EllipticWing_InflowWind_12mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
          ...
          1   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
